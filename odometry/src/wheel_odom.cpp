...
class WheelOdom : public rclcpp::Node
{
   public:
    ...
    {
        odom_pub_ = this->create_publisher<geometry_msgs::msg::Vector3Stamped>(
            "/wheel_odom", 10);
        encoder_sub_ =
            this->create_subscription<robp_interfaces::msg::Encoders>(
                "/motor/encoders",
                10,
                std::bind(
                    &WheelOdom::encodersCallback, this, std::placeholders::_1));
    }
   ...
   private:
    void encodersCallback(const robp_interfaces::msg::Encoders::SharedPtr msg)
    {
        ...
        geometry_msgs::msg::Vector3Stamped odom;
    ...
    rclcpp::Subscription<robp_interfaces::msg::Encoders>::SharedPtr
        encoder_sub_;
};
