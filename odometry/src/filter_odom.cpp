...
public:
    FilterOdom() : 
        node("filter_odom")
    {
        wheel_odom_sub_     = this->create_subscription<geometry_msgs::msg::Vector3>("/wheel_odom", 10, 
    ...
    void timer_callback() {
        ...
        double avg_lin = (wheels[0] + realsense[0])/2.0;
        double avg_ang = (wheels[1] + realsense[1])/2.0;
...
private: 
    ...
    rclcpp::Subscription<geometry_msgs::msg::Vector3>::SharedPtr wheel_odom_sub_;
