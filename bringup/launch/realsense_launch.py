...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',           'default': '640x480x30', 'description': 'color image width'},
                           ...
                           {'name': 'depth_module.depth_profile',         'default': '640x480x30', 'description': 'depth module profile'},
