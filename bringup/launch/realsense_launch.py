...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.profile',
                               'default': '640x480x30', 'description': 'color image width'},
                           ...
                           {'name': 'enable_infra',                 'default': 'false',
                               'description': 'enable infra0 stream'},
                           ...
                           {'name': 'depth_module.profile',         'default': '640x480x30',
                               'description': 'depth module profile'},
                           {'name': 'depth_module.depth_format',
                               'default': 'Z16', 'description': 'depth stream format'},
                           ...
                           {'name': 'enable_sync',                  'default': 'true',
                               'description': "'enable sync mode'"},
                           {'name': 'enable_rgbd',                  'default': 'true',
                               'description': "'enable rgbd topic'"},
                           {'name': 'enable_gyro',                  'default': 'true',
                               'description': "'enable gyro stream'"},
                           {'name': 'enable_accel',                 'default': 'true',
                           ...
                           {'name': 'pointcloud.enable',
                               'default': 'true', 'description': ''},
                           {'name': 'pointcloud.stream_filter',     'default': '2',
    ...
    return [
        launch_ros.actions.Node(
            ...
            namespace=LaunchConfiguration(
                'camera_namespace' + param_name_suffix),
